...
export const Home = () => {
    ...
    // const onSaveCart = (publicId: string) => {
    //     const cart: CartItem[] = JSON.parse(localStorage.getItem("cart") || "[]");

    //     const existing = cart.find(i => i.id === publicId);

    //     if (existing) {
    //         existing.qty += 1;
    //     } else {
    //         cart.push({ id: publicId, qty: 1 });
    //     }
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            ...
                                            {/* <a className="btn btn-sm btn-icon btn-primary" href="#!" onClick={() => onSaveCart(e.publicId)}>
                                                <i className="ti ti-basket fs-lg"></i>
                                            </a> */}
                                        </div>
                                    </article>
