class App {
    ...
    initComponents() {
        try {
            "undefined" != typeof lucide && "function" == typeof lucide.createIcons && lucide.createIcons(),
    ...
    initPortletCard() {
        ...
        document.querySelectorAll('[data-action="card-toggle"]').forEach(i => {
            i.addEventListener("click", e => {
                ...
                e && t && (t.style.transition = "height 0.35s ease-in-out, margin 0.35s ease-in-out",
                e.classList.contains("card-collapsed") ? (e.classList.remove("card-collapsed"),
        ...
        document.querySelectorAll('[data-action="card-refresh"]').forEach(e => {
            e.addEventListener("click", t => {
                ...
                if (t) {
                    ...
                    e || ((e = document.createElement("div")).className = "card-overlay",
                    (i = document.createElement("div")).className = "spinner-border text-primary",
                    e.appendChild(i),
                    t.appendChild(e)),
        ...
        document.querySelectorAll('[data-action="code-collapse"]').forEach(i => {
            i.addEventListener("click", e => {
                ...
                e && t && (t.style.transition = "height 0.35s ease-in-out",
                "none" === window.getComputedStyle(t).display ? (t.style.display = "block",
                t.style.height = "0",
                t.style.overflow = "hidden",
                e = t.scrollHeight,
                t.offsetHeight,
        ...
        let t = new IntersectionObserver( (e, n) => {
            e.forEach(s => {
                if (s.isIntersecting) {
                    ...
                    if (s) {
                        let e = s.replace(/,/g, ""), t = (e = parseFloat(e),
                        0), i, o = (i = Number.isInteger(e) ? Math.floor(e / 25) : e / 25,
                        () => {
                            t < e ? ((t += i) > e && (t = e),
                            a.innerText = r(t),
                            requestAnimationFrame(o)) : a.innerText = r(e)
                        }
                        );
                        function r(e) {
        ...
        document.querySelectorAll("[data-toggler]").forEach(e => {
            let t = e.querySelector("[data-toggler-on]")
              ...
              , a = () => {
                ...
                i?.classList.add("d-none")) : (t?.classList.add("d-none"),
                ...
                if (e && t) {
                    ...
                    if (100 < e) {
                        ...
                        !function e() {
                            ...
                            i = a,
                            o = s,
                            (t /= l / 2) < 1 ? o / 2 * t * t + i : -o / 2 * (--t * (t - 2) - 1) + i),
                            r < l && setTimeout(e, 20)
                        }()
                    }
                }
...
class LayoutCustomizer {
    ...
    applyPreset(e) {
        ...
        e.topbarColor && (this.config["topbar-color"] = e.topbarColor,
        this.html.setAttribute("data-topbar-color", e.topbarColor)),
        e.sidenavColor && (this.config["sidenav-color"] = e.sidenavColor,
        this.html.setAttribute("data-menu-color", e.sidenavColor)),
        e.sidenavSize && (this.config["sidenav-size"] = e.sidenavSize,
        this.html.setAttribute("data-sidenav-size", e.sidenavSize)),
        void 0 !== e.sidenavUser) && (this.config["sidenav-user"] = e.sidenavUser,
        e.sidenavUser ? this.html.setAttribute("data-sidenav-user", "true") : this.html.removeAttribute("data-sidenav-user"))
    }
    initConfig() {
    ...
    setSwitchFromConfig() {
        ...
        [["data-skin", e.skin], ["data-bs-theme", e.theme], ["data-menu-color", e["sidenav-color"]], ["data-sidenav-size", e["sidenav-size"]], ["data-topbar-color", e["topbar-color"]], ["data-layout-position", e.position], ["data-layout-width", e.width], ["dir", e.dir]].forEach( ([e,t]) => {
    ...
    initSwitchListener() {
        ...
        e('input[name="data-layout-width"]', e => this.changeLayoutWidth(e.value)),
    ...
    _toggleSidebar() {
        ...
        "offcanvas" === e ? this.showBackdrop() : "compact" === t ? this.changeSidenavSize("condensed" === e ? "compact" : "condensed", !1) : this.changeSidenavSize("condensed" === e ? "default" : "condensed", !0),
    ...
    activeThemeDropdownItem() {
        ...
        e && 0 < e.length && e.forEach(e => {
            ...
            i && (e = document.getElementById("theme-icon-light"),
            ...
            t) && t.classList.toggle("d-none", "system" !== o)
        }
        )
    }
}
class Plugins {
    ...
    initFlatPicker() {
        document.querySelectorAll("[data-provider]").forEach(e => {
            ...
            "flatpickr" === t ? (i["data-date-format"] && (o.dateFormat = i["data-date-format"].value),
            i["data-enable-time"] && (o.enableTime = !0,
            o.dateFormat += " H:i"),
            i["data-altFormat"] && (o.altInput = !0,
            ...
            i["data-default-date"] && (o.defaultDate = i["data-default-date"].value),
            i["data-multiple-date"] && (o.mode = "multiple"),
            i["data-range-date"] && (o.mode = "range"),
            i["data-inline-date"] && (o.inline = !0,
            o.defaultDate = i["data-default-date"].value),
            i["data-disable-date"] && (o.disable = i["data-disable-date"].value.split(",")),
            i["data-week-number"] && (o.weekNumbers = !0),
            flatpickr(e, o)) : "timepickr" === t && (o = {
                enableTime: !0,
                noCalendar: !0,
                dateFormat: "H:i",
                defaultDate: new Date
            ...
            i["data-default-time"] && (o.defaultDate = i["data-default-time"].value),
            i["data-time-inline"] && (o.inline = !0,
...
class I18nManager {
    constructor({defaultLang: e="en", langPath: t="assets/data/translations/", langImageSelector: i="#selected-language-image", langCodeSelector: o="#selected-language-code", translationKeySelector: a="[data-lang]", translationKeyAttribute: s="data-lang", languageSelector: r="[data-translator-lang]"}={}) {
    ...
    bindLanguageSwitchers(i) {
        this.languageButtons.forEach(t => {
            t.addEventListener("click", () => {
                ...
                i) && i.changeLayoutDirection("ar" === e ? "rtl" : "ltr")
            }
            )
        }
        )
...
class CustomApexChart {
    constructor({selector: e, series: t=[], options: i={}, colors: o=[]}) {
        if (e) {
            this.selector = e,
            this.series = t,
            this.getOptions = i,
    ...
    injectDynamicColors(e, i) {
        ...
        e.plotOptions.boxPlot.colors.upper = e.plotOptions.boxPlot.colors.upper || i[0],
        e.plotOptions.boxPlot.colors.lower = e.plotOptions.boxPlot.colors.lower || i[1]),
        ...
        "gradient" === e.fill?.type && e.fill.gradient && (e.fill.gradient.gradientToColors = e.fill.gradient.gradientToColors || i),
        e.plotOptions?.treemap?.colorScale?.ranges && (0 < (t = e.plotOptions.treemap.colorScale.ranges).length && !t[0].color && (t[0].color = i[0]),
        1 < t.length) && !t[1].color && (t[1].color = i[1]),
        e
    }
    static rerenderAll() {
...
class CustomEChart {
    constructor({selector: e, options: t={}, theme: i=null, initOptions: o={}}) {
        if (e) {
            this.selector = e,
            this.element = null,
            this.getOptions = t,
